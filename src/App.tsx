...
import { convert_0x2A5D, convert_0x2A63, convert_0x2A65, convert_0x2ACC, flags_0x2A63, flags_0x2A65, flags_0x2ACC } from './lib/convert'
...
function App() {
  ...
  const test = async () => {
    ...
    read_0x2ACC.refresh().then(v => {
      ...
      console.log("value.flags", value.fitnessMachineFeatures);
    });
